...
import com.lazy.sentinel.permission.api.IPermissionsRoleGroupRelService;
import com.lazy.sentinel.permission.api.entity.TPermissionsRoleGroupRelEntity;
import com.lazy.sentinel.permission.dao.IPermissionsRoleGroupRelRepository;
...
public class PermissionsRoleGroupRelServiceImpl extends BaseServiceImpl<TPermissionsRoleGroupRelEntity, Long> implements IPermissionsRoleGroupRelService {
     ...
     */
    @Autowired
    public PermissionsRoleGroupRelServiceImpl(IPermissionsRoleGroupRelRepository repository) {
        super();
